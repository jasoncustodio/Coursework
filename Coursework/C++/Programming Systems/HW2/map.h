...
const int EXIT     = 5;    //Used to exit the program
...
const int MAXLIST  = 4;    //Number of max players in a pNode array
...
class node
{
    public:
            ...
            int compare(int);        //Compare user answer, 0 is false, 1 is true
